...
var file_word_service_proto_rawDesc = []byte{
	...
	0x49, 0x64, 0x22, 0x88, 0x03, 0x0a, 0x0b, 0x57, 0x6f, 0x72, 0x64, 0x4d, 0x65, 0x61, 0x6e, 0x69,
	...
	0x57, 0x6f, 0x72, 0x64, 0x4d, 0x65, 0x61, 0x6e, 0x69, 0x6e, 0x67, 0x49, 0x64, 0x32, 0xd2, 0x01,
...
var file_word_service_proto_msgTypes = make([]protoimpl.MessageInfo, 8)
var file_word_service_proto_goTypes = []interface{}{
	...
	(*WordMeaning)(nil),                       // 7: pb.WordMeaning
}
var file_word_service_proto_depIdxs = []int32{
	7, // 0: pb.FindWordByDictionaryResponse.word_meanings:type_name -> pb.WordMeaning
	...
	5, // 5: pb.WordService.CreateFavoriteWordMeaning:input_type -> pb.CreateFavoriteWordMeaningRequest
	1, // 6: pb.WordService.FindWordByDictionary:output_type -> pb.FindWordByDictionaryResponse
	6, // 7: pb.WordService.CreateFavoriteWordMeaning:output_type -> pb.CreateFavoriteWordMeaningResponse
